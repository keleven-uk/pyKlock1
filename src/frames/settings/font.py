...
class MyFontFrame(ctk.CTkFrame):
    ...
    def __createWidgets(self):
        ...
        timeFont = f"    Main Time Font Family {self.myConfig.TIME_FONT_FAMILY} with size {self.myConfig.TIME_FONT_SIZE}"
        ...
        statusFont = f"    Main Time Font Family {self.myConfig.STATUS_FONT_FAMILY} with size {self.myConfig.STATUS_FONT_SIZE}"
    ...
    def __askStatusFont(self):
        ...
        font = askfont(self)
                # font is "" if the user has cancelled
        #if font:
            # self.myConfig.STATUS_FONT_FAMILY = font["family"]
            # self.myConfig.STATUS_FONT_SIZE   = font["size"]
