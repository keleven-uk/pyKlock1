###############################################################################################################
#    dialKlock   Copyright (C) <2025>  <Kevin Scott>                                                          #
...
import src.frames.showDialTime as dialTime

class dialKlock(ctk.CTkToplevel):
    """  A class to display current time using Speedometer type dials.
    """
    def __init__(self, master, myConfig, myLogger):
        ...
        self.winWidth   = (self.klockSize * 3) + 150
        self.winHeight  = self.klockSize + 40
        ...
        self.mainTime = dialTime.showDialKlock(self, self.master, self.myConfig, self.myLogger)
